...
dirTupleG2=dir+"cu1DE_keywordcitations.csv"
# dir="D:/publications/GitWksp/WoSdata/ngeo/"
df=WoSdataparser.GenerateTRef(dir)
df.to_csv(dirTuple)
df2=pd.read_csv(dir+"keywordlist.csv")
keywordlist=df2["keyword"]
...
for stdei in stde:
    ...
    for w in stdeis:
        ...
        # test if the keywords have already been in the keyword list.
        flag=True
        for wp in wlTCSTC:
            if wp and w == wp[0]:
